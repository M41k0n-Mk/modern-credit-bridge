...
/**
 * Anti-Corruption Layer (ACL) que protege o modelo de domínio das peculiaridades do formato legado
 * do mainframe. Faz parsing/normalização e devolve uma Proposta consistente com a Linguagem Ubíqua
 * do domínio.
 */
public final class PropostaLegacyAcl {
  ...
  public static Proposta mapearParaProposta(PropostaLegacyDTO dto) {
    ...
    // Para id usamos um UUID gerado, mas mantemos o idLegado em logs (ou criar mapeamento adicional
    // se necessário)
