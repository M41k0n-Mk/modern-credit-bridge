...
/**
 * Entidade de domínio que representa uma Proposta de Crédito. Encapsula regras de negócio e
...
public class Proposta {
  ...
  /**
   * Construtor privado para garantir validação via factory method ou construtor público com
   * validação.
   */
  @Deprecated
  ...
  /**
   * Construtor de compatibilidade para testes e camadas antigas. Evita quebra ao migrar para VOs e
   * enum.
   */
  @Deprecated
