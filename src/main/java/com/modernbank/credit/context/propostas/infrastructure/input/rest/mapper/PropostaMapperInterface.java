...
/**
 * Mapper com MapStruct para conversão entre DTOs e Entidades de Domínio. MapStruct automatiza a
 * geração de código de conversão em tempo de compilação.
 *
 * <p>Benefícios: - Performance: Conversão feita em compile-time (sem reflexão) - Type-safe:
 * Verificação de tipos em tempo de compilação - Menos boilerplate: Não precisa escrever
 * getters/setters manualmente - Facilmente extensível: Dapat adicionar custom mappings
 */
