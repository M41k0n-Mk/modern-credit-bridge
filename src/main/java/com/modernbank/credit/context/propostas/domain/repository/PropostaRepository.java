package com.modernbank.credit.context.propostas.domain.repository;
...
/**
 * Interface do repositório de Propostas. Define o contrato para operações de persistência de
 * propostas. Implementação: responsabilidade da camada de infraestrutura (Spring Data JPA).
 *
 * <p>PADRÃO: Repository Pattern (Domain-Driven Design) Objetivo: Isolar a lógica de acesso a dados
 * da camada de negócio.
 */
public interface PropostaRepository {

  /**
   * Salva uma proposta no banco de dados. Se já existe, atualiza; caso contrário, insere.
   *
