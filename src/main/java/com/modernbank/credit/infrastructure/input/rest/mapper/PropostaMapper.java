 ...
 * Mapeia dados da camada de entrada (API) para o domínio e vice-versa.
 * 
 * PADRÃO: Mapper / Converter (Anti-Corruption Layer)
 * Objetivo: Isolar as mudanças entre camadas, facilitando manutenção.
 * 
 * Nota: Poderia usar MapStruct para automatizar essas conversões em projetos maiores.
 * 
 * @author ModernBank
 */
