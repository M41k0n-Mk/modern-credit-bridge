...
import com.modernbank.credit.infrastructure.output.persistence.entity.repository.SpringDataPropostaRepository;
...
public class PropostaRepositoryAdapter implements PropostaRepository {
    ...
    public Proposta salvar(Proposta proposta) {
        ...
        if (log.isInfoEnabled()) {
            log.info("[PropostaRepositoryAdapter] Proposta salva. id={} status={}", dominio.getId(), dominio.getStatus());
        }
        return dominio;
    }
