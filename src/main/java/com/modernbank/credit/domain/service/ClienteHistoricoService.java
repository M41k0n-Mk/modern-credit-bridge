package com.modernbank.credit.domain.service;

import java.math.BigDecimal;

/**
 * Domain Service responsável por consultar histórico do cliente
 * em sistemas legados (Mainframe) ou bancos de grafos (fraude),
 * retornando um nível de risco para a proposta.
 */
